...
**Dev:** @eslint/js, @types/node, @types/react, @types/react-dom, @vitejs/plugin-react, autoprefixer, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, lucide-react, postcss, tailwindcss, typescript, typescript-eslint, vite
